...
public class Main {
    ...
    public static void main(String args[]) {
        ...
        while (humanPlayerList.size() > 1) { // to check there is more than 1 village left
            ...
            for (int i = 0; i < humanPlayerList.size(); i++) {
                ...
                HumanPlayer currentPlayer = humanPlayerList.get(i); // storing in variable to allow easier reference
                ...
                actions_loop: while (true) {
                    ...
                    switch (userChoice) {
                        ...
                        case 5: { // surrender
                            ...
                            map.removeVillage(currentPlayer.getXCoordinate(), currentPlayer.getYCoordinate(), currentPlayer.getPlayerID());
                            break actions_loop;
                        }
